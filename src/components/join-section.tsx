                    ...
                    <div className="relative z-0 flex flex-col bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                        ...
                        <div className="flex-auto p-6">
                            <form onSubmit={handleSubmit}>
                                ...
                                <button
                                    type="button"
                                    onClick={() => window.open('https://wa.me/+555198660241', '_blank', '_blank')}
                                    className="w-full px-6 py-3 mt-4 font-bold text-white uppercase transition-all rounded-lg shadow-soft-md bg-green-600 hover:bg-green-700 flex items-center justify-center gap-2"
                                >
