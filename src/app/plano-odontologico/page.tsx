export default function Page() {
  return (
    ...
    >
      <div className="container mx-auto gap-4 flex px-4 flex-col md:flex-row h-full text-black mt-9">
        <div className="w-full h-full gap-8">
          <div className="flex flex-col">
            <h1 className="text-3xl font-bold text-red-700">Plano Odontológico</h1>
      ...
      <div className="container mx-auto gap-4 px-4 flex flex-col w-full h-full mt-9 mb-3">
        <h2 className="text-2xl font-bold text-red-700">COMO ADERIR?</h2>
        <p className="text-lg gap-2 mt-2">
