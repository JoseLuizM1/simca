  ...
  return (
    ...
    >
      <div className="container mx-auto gap-4 flex flex-col justify-center h-full text-white py-6 px-4 sm:py-8 sm:px-4 md:px-6 lg:px-8 w-full max-w-full sm:max-w-2xl md:max-w-3xl">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl mb-2">Assessoria Jurídica Gratuita</h2>

        <p className="mb-2 text-sm sm:text-base md:text-lg lg:text-xl">
        ...
        <div className="mb-2 text-sm sm:text-base md:text-lg lg:text-xl">
          <p className="text-sm sm:text-base md:text-lg font-semibold text-white mb-1">Horários de atendimento:</p>
